...
Include the criterion type group name in this field if you want the "target and bid" option. 

Exclude the criterion type group name from this field if you want the "bid only" option.
...
|-----------------|---------------|---------------|
|Age|Audience|Details for audience campaigns are coming soon.|
...
|CompanyName|Audience|Details for audience campaigns are coming soon.|
|Gender|Audience|Details for audience campaigns are coming soon.|
|Industry|Audience|Details for audience campaigns are coming soon.|
|JobFunction|Audience|Details for audience campaigns are coming soon.|
